<section class="container d-flex align-items-center justify-content-center min-vh-100">
    <div class="card my-5 w-100">
      ...
      <div class="card-body"> 
        <form class="grid" method="post" action="index.php?page=admin_pedido&mode={{mode}}&venta_id={{venta_id}}">
  
          <div class="row">
            <label class="col-12 col-m-4 flex center" for="categoria_id">Código</label>
            <input type="hidden" class="width-full center" class="form-control" id="venta_id" name="venta_id" value="{{venta_id}}"/>
          ...
          <div class="row">
            <label class="col-12 col-m-4 flex center" for="usuario_id">Codigo del Cliente</label>
            <input class="width-full center" type="text" class="form-control" readonly id="usuario_id" name="usuario_id" value="{{usuario_id}}" maxlength="80">
          </div>
          ...
          <div class="row">
            ...
            <textarea class="form-control" type="text" class="form-control" readonly id="cliente_dir" name="cliente_dir" maxlength="300">{{clienteDir}}</textarea>
          </div>
          ...
          <div class="table-responsive table-hover rounded py-3">
            ...
            <tbody>
                {{foreach Productos}}
                <tr>
                    <td class="text-center align-middle">{{comic_id}}</td>
