<section class="container-fluid min-vh-100">
    ...
    <div class="table-responsive table-hover rounded">
        ...
        <thead class="thead text-light" style="background-color: #653719">
            ...
            <th class="text-center align-middle">Codigo del Cliente</th>
        ...
        <tbody>
            {{foreach items}}
            <tr>
                <td class="text-center align-middle"><a href="index.php?page=admin_pedido&mode=DSP&venta_id={{venta_id}}">{{venta_id}}</a></td>
                ...
                <td class="text-center align-middle">{{usuario_id}}</td>
